...
export const setClientTimeout = (minutesUntilTimeout: number) => {
  store.set(
    'quiq-client-timeout',
    expireInMinutes(minutesUntilTimeout),
    expireInMinutes(minutesUntilTimeout),
  );
};
...
export const getClientTimeout = () => store.get('quiq-client-timeout');
