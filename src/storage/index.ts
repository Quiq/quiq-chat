...
export const initialize = (mode: StorageMode, contactPoint: string) => {
    ...
    // This allows switching back and forth between mechanism without disrupting active chats.
