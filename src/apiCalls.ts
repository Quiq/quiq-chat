...
const getHost = (cached: boolean): string => {
    ...
    try {
        ...
        const vanityName =
            ChatState.host.hostname && ChatState.host.hostname.split('.')[0];
...
export const getAttachmentMessageUploadDirectives = (numUploads: number = 1,): Promise<UploadDirectivesResponse> =>
    quiqFetch(
